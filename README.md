...
## In This Project we will use Python function to create a RDBMS. I'm using defensive programming strategy as you might aware to handle exceptions in try exception block to keep the data consistent and if any value of data is missing we will introduce None in its place.
