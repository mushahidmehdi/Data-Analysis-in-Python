...
![GitHub repo size](https://img.shields.io/github/repo-size/mushahidmehdi/JSON-Data-Analysis-in-Python)
https://img.shields.io/steam/favorites/100?style=plastic)
...
## In This Project we will use Python function to create a RDBMS. I'm using defensive programming strategy as you might aware to handle exceptions in try except block to keep the data consistent and if any value of data is missing we will introduce None in its place.
